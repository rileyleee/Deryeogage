...
public class PostCostDto {
    ...
    @Builder
    public PostCostDto(Integer id, long userId, int boardId, String cost, Boolean payYn, LocalDateTime payDate, Boolean returnYn, LocalDateTime returnDate) {
        this.id = id;
        this.userId = userId;
    ...
    public PostCostEntity toEntity(UserRepository userRepository, BoardRepository boardRepository){
