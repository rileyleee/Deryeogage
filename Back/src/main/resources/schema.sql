...
-- ALTER TABLE `pretest` ADD CONSTRAINT `PK_PRETEST` PRIMARY KEY (
-- 	`id`
-- );

-- ALTER TABLE `pre_cost` ADD CONSTRAINT `PK_PRE_COST` PRIMARY KEY (
-- 	`id`
-- );
...
-- ALTER TABLE `simulation` ADD CONSTRAINT `PK_SIMULATION` PRIMARY KEY (
-- 	`id`
-- );
...
-- ALTER TABLE `post_cost` ADD CONSTRAINT `PK_POST_COST` PRIMARY KEY (
-- 	`id`
-- );
...
-- ALTER TABLE `detail_code` ADD CONSTRAINT `PK_DETAIL_CODE` PRIMARY KEY (
-- 	`value`
-- );

-- ALTER TABLE `master_code` ADD CONSTRAINT `PK_MASTER_CODE` PRIMARY KEY (
-- 	`id`
-- );
