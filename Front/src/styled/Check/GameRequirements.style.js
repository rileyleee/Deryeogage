...
export const GameStartsecond = styled.div`
    &.second {
        height: 70vh;
        padding: 1vh;
        background-image: url("assets/corgi 2/idle2.gif"), url("assets/things/meat.png"), url("assets/things/bubble.png"), url("assets/home/home2.png");
        background-repeat: no-repeat;
        background-position: 50% 95%, 73% 63%, 75% 65%, center;
        background-size: 35% 40%, 10% 15%, 20% 20%, cover;
    }
`
